...
class Userr():
	def __init__(self,excel_file, db_file):
		...
		## Tab_Col_Excel={'BUS': ['NO'.,,,], 'LINE': ['NO',...]}
		self.Tab_Col_Excel=self.__Tab_Col_Excel__(wb)

		self.conn=sqlite3.connect(db_file)
		self.cursor=self.conn.cursor()

		## Tab_Col_SQL={'BUS': ['NO', 'NAME', 'kV', 'Code'], 'Line': ['NO','RATE_A']}
		self.Tab_Col_SQL, self.Len_Tab=self.__Tab_Col_SQL__()

		## Insert={}
		## Update={'BUS': [(1, 'BUS1',....),(3, 'BUS3',,...)], 'Đường_dây': [(1, ...)}
	...
	def __Tab_Col_SQL__(self):
		...
		## Lấy tên tất cả các bảng trong SQL
...
if __name__ == '__main__':
	...
	db_file='5nut.db'
	userrr=Userr(excel_file,db_file)
	userrr.print()
	userrr.main()
